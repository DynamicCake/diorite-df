...
pub struct ActionDump {
    pub codeblocks: Vec<Arc<Codeblock>>,
    pub actions: Vec<Arc<Action>>,
    pub game_value_categories: Vec<Arc<GameValueCategory>>,
    pub game_values: Vec<Arc<GameValue>>,
    pub particle_categories: Vec<Arc<ParticleCategory>>,
    pub particles: Vec<Arc<Particle>>,
    pub sound_categories: Vec<Arc<SoundCategory>>,
    pub sounds: Vec<Arc<Sound>>,
    pub potions: Vec<Arc<Potion>>,
    pub cosmetics: Vec<Arc<Cosmetic>>,
    pub shops: Vec<Arc<Shop>>,
}
...
impl ActionDump {
    ...
    pub fn suggest_sub_actions<'d>(
        ...
        res.truncate(3);
        res.into_iter().map(|(action, _)| action.clone()).collect()
    }
